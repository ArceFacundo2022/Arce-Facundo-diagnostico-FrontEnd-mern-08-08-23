          ...
          <form action="">
            <div className="row">
              ...
              <div className="form-group input-group flex-nowrap">
                <input type="text" name="" className="form-control" id="titulo" required onChange={(e) => { setInicio({ ...inicio, "titulo": e.target.value }) }} />
              </div>
              ...
              <div className="form-group mt-2 input-group flex-nowrap">
                <input type="text" className="form-control" name="" id="descripcion" required onChange={(e) => { setInicio({ ...inicio, "descripcion": e.target.value }) }} />
              </div>
            </div>
          </form>
        </Modal.Body>
